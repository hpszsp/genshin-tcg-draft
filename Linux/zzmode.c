...
int main(int argc, char* argv[])
{
	...
	{
		system("echo \"\e[92mWarning:character.cfg不是以00000开头，这可能导致你的部分角色不被读取，或者出现乱码\"");
		system("echo \"\e[0m\"");
		printf("\n");
		usleep(3000000);
	}
	...
	for (int i = 0;; i = i + 6)
	{
		...
		if (i >= 2000)
		{
			system("echo \"\e[31mError:遇到了错误，可能是输入的角色数多于300个，也可能是character.cfg中间有回车或者不是以aaaaa结尾\"");
			printf("\n");
			usleep(3000000);
			return 0;
		}
